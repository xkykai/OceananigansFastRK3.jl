...
# Mask immersed cells before computing norms so solid points do not enter errors.
...
# L2 and L∞ saturate at different CFLs in the staircase case.
markersize = 13
linewidth = 2
...
# Staircase timings store one row per Δt and one column per trial.
